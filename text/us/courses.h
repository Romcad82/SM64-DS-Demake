...
SECRET_STAR(COURSE_TSOBF, _("   THE SECRET OF BATTLE FORT"))
SECRET_STAR(COURSE_SI, _("   SUNSHINE ISLES"))
SECRET_STAR(COURSE_GB, _("   GOOMBOSS BATTLE"))
SECRET_STAR(COURSE_BBB, _("   BIG BOO BATTLE"))
SECRET_STAR(COURSE_CCC, _("   CHIEF CHILLY CHALLENGE"))
