...
Star will appear\n\
inside the Star Sphere."))

DEFINE_DIALOG(DIALOG_171, 1, 4, 95, 200, _("\
Hello!\n\
Please take a look\n\
at the map below.\n\
Memorized it?\n\
...
DEFINE_DIALOG(DIALOG_172, 1, 6, 30, 200, _("\
...
DEFINE_DIALOG(DIALOG_173, 1, 5, 30, 200, _("\
Hop onto high places\n\
with the wall kick.\n\
Just jump at a wall,\n\
...
DEFINE_DIALOG(DIALOG_175, 1, 3, 30, 200, _("\
HIGH WIND WARNING!\n\
You'll be blown away unless\n\
you put on some weight!"))

DEFINE_DIALOG(DIALOG_176, 1, 3, 95, 200, _("\
It's locked...\n\
Everything is quiet\n\
on the other side."))

DEFINE_DIALOG(DIALOG_177, 1, 6, 30, 200, _("\
Oh, no! Oh, no!\n\
I lost the keys to\n\
Princess Toadstool's\n\
secret drawer! She's\n\
...
It looks like the\n\
keys are long gone.\n\
It's a shame, you could've\n\
gone into the Rec Room\n\
to play some mini-games."))

DEFINE_DIALOG(DIALOG_178, 1, 5, 30, 200, _("\
My castle is in great\n\
peril!! I know it's\n\
because of Bowser\n\
...
DEFINE_DIALOG(DIALOG_179, 1, 4, 95, 200, _("\
It takes the power of\n\
12 Stars to open this\n\
door. You need [%] more\n\
Stars."))

DEFINE_DIALOG(DIALOG_180, 1, 4, 150, 200, _("\
You've recovered 12\n\
Power Stars!\n\
...
My underlings locked\n\
you up in that room.\n\
Never mind.\n\
I'll deal with you myself!\n\
Now I will trample you\n\
as you have trampled us!"))

DEFINE_DIALOG(DIALOG_182, 1, 5, 30, 200, _("\
Aaaaauuuuuuurrghhh!\n\
I am so angry I am\n\
cooking in my own\n\
succulent juices!\n\
...
DEFINE_DIALOG(DIALOG_183, 1, 5, 30, 200, _("\
Eee hee hee...\n\
I am Big Boo, the\n\
spookiest of all the\n\
spirits. I love scaring\n\
wimpy humans.\n\
Eee hee hee...\n\
You'll never sneak behind\n\
me!"))

DEFINE_DIALOG(DIALOG_184, 1, 5, 30, 200, _("\
Eee hee hee!\n\
...
DEFINE_DIALOG(DIALOG_185, 1, 6, 30, 200, _("\
You there with a\n\
mustache! I am the king\n\
of cold, Chief Chilly. I\n\
lock up anyone who\n\
challenges the greatness\n\
of my mustache.\n\
I am the mustache\n\
master! In fact, I locked\n\
up a rude fellow just the\n\
other day.\n\
\n\
\n\
...
DEFINE_DIALOG(DIALOG_186, 1, 6, 30, 200, _("\
Dang!!\n\
