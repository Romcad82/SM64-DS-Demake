...
const BehaviorScript bhvFiveCoinsSpawn[] = {
	BEGIN(OBJ_LIST_DEFAULT),
	OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
	BEGIN_REPEAT(5),
		SPAWN_CHILD(/*Model*/ MODEL_YELLOW_COIN, /*Behavior*/ bhvSingleCoinGetsSpawned),
...
const BehaviorScript bhvBbbTumblingBridge[] = {
	BEGIN(OBJ_LIST_SPAWNER),
	OR_INT(oFlags, (OBJ_FLAG_ACTIVE_FROM_AFAR | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
	SET_HOME(),
	SET_INT(oBehParams2ndByte, TUMBLING_BRIDGE_BP_BBB),
	BEGIN_LOOP(),
		CALL_NATIVE(bhv_tumbling_bridge_loop),
	END_LOOP(),
};
...
const BehaviorScript bhvGbUpDownLog[] = {
	BEGIN(OBJ_LIST_SURFACE),
	OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
	LOAD_COLLISION_DATA(gb_up_down_log_collision),
	SET_HOME(),
	CALL_NATIVE(bhv_gb_up_down_log_init),
	BEGIN_LOOP(),
		CALL_NATIVE(bhv_gb_up_down_log_loop),
		CALL_NATIVE(load_object_collision_model),
	END_LOOP(),
};
...
const BehaviorScript bhvStarSwitch[] = {
	BEGIN(OBJ_LIST_SURFACE),
	SET_INT(oBehParams2ndByte, PURPLE_SWITCH_BP_SPAWN_STAR),
	// Floor switch - common:
	OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
...
const BehaviorScript bhvFallingIcePlatformA[] = {
	BEGIN(OBJ_LIST_SURFACE),
	SET_INT(oBehParams2ndByte, 1),
	GOTO(bhvFallingIcePlatform + 1),
};

const BehaviorScript bhvFallingIcePlatformB[] = {
	BEGIN(OBJ_LIST_SURFACE),
	SET_INT(oBehParams2ndByte, 2),
	GOTO(bhvFallingIcePlatform + 1),
};

const BehaviorScript bhvFallingIcePlatformC[] = {
	BEGIN(OBJ_LIST_SURFACE),
	SET_INT(oBehParams2ndByte, 3),
	GOTO(bhvFallingIcePlatform + 1),
};

const BehaviorScript bhvFallingIcePlatform[] = {
	BEGIN(OBJ_LIST_SURFACE),
	// Common:
	OR_LONG(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_DONT_CALC_COLL_DIST)),
	SET_FLOAT(oDrawingDistance, 20000),
	...
	SET_HOME(),
	BEGIN_LOOP(),
		CALL_NATIVE(bhv_falling_ice_platform_loop),
		CALL_NATIVE(load_object_collision_model),
	END_LOOP(),
};
...
const BehaviorScript bhvCccMovingOctagonalMeshPlatform[] = {
	BEGIN(OBJ_LIST_SURFACE),
	OR_INT(oFlags, (OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
	ADD_FLOAT(oPosY, -50),
	LOAD_COLLISION_DATA(moving_octagonal_mesh_platform_collision),
	BEGIN_LOOP(),
		CALL_NATIVE(bhv_lll_moving_octagonal_mesh_platform_loop),
		CALL_NATIVE(load_object_collision_model),
	END_LOOP(),
...
const BehaviorScript bhvGbTiltingInvertedPyramid[] = {
	BEGIN(OBJ_LIST_SURFACE),
	OR_INT(oFlags, (OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
	LOAD_COLLISION_DATA(gb_seg7_collision_inverted_pyramid),
	ADD_FLOAT(oPosY, 5),
	SET_HOME(),
	CALL_NATIVE(bhv_platform_normals_init),
	BEGIN_LOOP(),
...
const BehaviorScript bhvCccTiltingInvertedPyramid[] = {
	BEGIN(OBJ_LIST_SURFACE),
	OR_INT(oFlags, (OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
	LOAD_COLLISION_DATA(ccc_seg7_collision_inverted_pyramid),
	ADD_FLOAT(oPosY, 5),
	SET_HOME(),
	CALL_NATIVE(bhv_platform_normals_init),
	BEGIN_LOOP(),
...
const BehaviorScript bhvArrowSignLeft[] = {
	BEGIN(OBJ_LIST_SURFACE),
	LOAD_COLLISION_DATA(arrow_sign_left_collision),
	GOTO(bhvArrowSignRight + 1 + 2),
};

const BehaviorScript bhvArrowSignRight[] = {
	BEGIN(OBJ_LIST_SURFACE),
	LOAD_COLLISION_DATA(arrow_sign_right_collision),
	OR_INT(oFlags, (OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
	BEGIN_LOOP(),
		CALL_NATIVE(load_object_collision_model),
	END_LOOP(),
...
const BehaviorScript bhvKingBoo[] = {
	...
	SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 30, /*Gravity*/ 0, /*Bounciness*/ -50, /*Drag strength*/ 1000, /*Friction*/ 1000, /*Buoyancy*/ 200, /*Unused*/ 0, 0),
	CALL_NATIVE(bhv_init_room),
	CALL_NATIVE(bhv_king_boo_init),
	BEGIN_LOOP(),
		CALL_NATIVE(bhv_king_boo_loop),
	END_LOOP(),
};
...
const BehaviorScript bhvRedCoinBoo[] = {
	BEGIN(OBJ_LIST_DEFAULT),
	DISABLE_RENDERING(),
	CALL_NATIVE(bhv_red_coin_boo_init),
	DEACTIVATE(),
};
...
const BehaviorScript bhvBbbTiltingTrapPlatform[] = {
	BEGIN(OBJ_LIST_SURFACE),
	...
	LOAD_COLLISION_DATA(bbb_trap_door_collision),
	SET_FLOAT(oCollisionDistance, 3000),
	SET_HOME(),
	SET_INT(oRoom, 3),
	BEGIN_LOOP(),
...
const BehaviorScript bhvBbbMerryGoRound[] = {
	BEGIN(OBJ_LIST_SURFACE),
	OR_INT(oFlags, (OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
	LOAD_COLLISION_DATA(bbb_merry_go_round_collision),
	SET_FLOAT(oCollisionDistance, 2000),
	SET_INT(oRoom, 1),
	BEGIN_LOOP(),
		CALL_NATIVE(bhv_bbb_merry_go_round_loop),
		CALL_NATIVE(load_object_collision_model),
	END_LOOP(),
};
...
const BehaviorScript bhvStarReference[] = {
	BREAK(),
};
...
const BehaviorScript bhvCustomDoorWarp[] = {
	BREAK(),
};
...
const BehaviorScript bhvLitBobomb[] = {
	BEGIN(OBJ_LIST_DESTRUCTIVE),
	OR_INT(oFlags, (OBJ_FLAG_PERSISTENT_RESPAWN | OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_HOLDABLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
	LOAD_ANIMATIONS(oAnimations, bobomb_seg8_anims_0802396C),
	DROP_TO_FLOOR(),
	...
	SET_INT(oIntangibleTimer, 0),
	SET_HOME(),
	CALL_NATIVE(bhv_lit_bobomb_init),
	BEGIN_LOOP(),
		CALL_NATIVE(bhv_bobomb_loop),
	END_LOOP(),
};
...
const BehaviorScript bhvMessagePanel[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)), // Original: OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    ...
    CALL_NATIVE(bhv_init_room),
    // Original: CALL_NATIVE(load_object_static_model),
    BEGIN_LOOP(),
        //
        CALL_NATIVE(bhv_poundable_signpost_update),
        CALL_NATIVE(load_object_collision_model),
        //
        SET_INT(oIntangibleTimer, 0),
        SET_INT(oInteractStatus, INT_STATUS_NONE),
...
const BehaviorScript bhvChiefChilly[] = {
	...
	OR_INT(oFlags, (OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
	LOAD_ANIMATIONS(oAnimations, chilly_chief_seg6_anims_06003994),
	SPAWN_CHILD(/*Model*/ MODEL_NONE, /*Behavior*/ bhvSquishMarioObj),
	DROP_TO_FLOOR(),
	SET_HOME(),
	SET_INT(oBullySubtype, 0x0010),
	CALL_NATIVE(bhv_chief_chilly_init),
	BEGIN_LOOP(),
		SET_INT(oIntangibleTimer, 0),
...
const BehaviorScript bhvTsobfBowlingBallSpawner[] = {
	BEGIN(OBJ_LIST_GENACTOR),
	OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
	SET_INT(oBBallSpawnerPeriodMinus1, 127),
	CALL_NATIVE(bhv_generic_bowling_ball_spawner_init),
...
const BehaviorScript bhvSilversHiddenStar[] = {
	BEGIN(OBJ_LIST_LEVEL),
	OR_INT(oFlags, (OBJ_FLAG_PERSISTENT_RESPAWN | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
	SET_INTERACT_TYPE(INTERACT_TEXT),
	SET_HITBOX_WITH_OFFSET(/*Radius*/ 100, /*Height*/ 180, /*Downwards offset*/ 80),
	SET_INT(oIntangibleTimer, 0),
	CALL_NATIVE(bhv_silvers_hidden_star_init),
	BEGIN_LOOP(),
		CALL_NATIVE(bhv_silvers_hidden_star_loop),
	END_LOOP(),
};

const BehaviorScript bhvHiddenSwitchStar[] = {
	BEGIN(OBJ_LIST_LEVEL),
	OR_INT(oFlags, (OBJ_FLAG_PERSISTENT_RESPAWN | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
	SET_INTERACT_TYPE(INTERACT_TEXT),
	SET_HITBOX_WITH_OFFSET(/*Radius*/ 100, /*Height*/ 180, /*Downwards offset*/ 80),
	SET_INT(oIntangibleTimer, 0),
	CALL_NATIVE(bhv_hidden_switch_star_init),
	BEGIN_LOOP(),
		CALL_NATIVE(bhv_hidden_switch_star_loop),
	END_LOOP(),
};
...
const BehaviorScript bhvSilverStar[] = {
	BEGIN(OBJ_LIST_LEVEL),
	OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
	SET_INTERACT_TYPE(INTERACT_SILVER_STAR),
	SET_HITBOX_WITH_OFFSET(/*Radius*/ 100, /*Height*/ 50, /*Downwards offset*/ -50),
	SET_INT(oIntangibleTimer, 0),
	SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 30, /*Gravity*/ -150, /*Bounciness*/ -70, /*Drag strength*/ 1000, /*Friction*/ 1000, /*Buoyancy*/ 0, /*Unused*/ 0, 0),
...
const BehaviorScript bhvSpawnObjectFromAnother[] = {
	BEGIN(OBJ_LIST_LEVEL),
	OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
	SET_HITBOX(/*Radius*/ 100, /*Height*/ 100),
	SET_INT(oIntangibleTimer, 0),
	CALL_NATIVE(bhv_spawn_object_from_another_init),
	BEGIN_LOOP(),
		CALL_NATIVE(bhv_follow_object_loop),
	END_LOOP(),
};

const BehaviorScript bhvSpawnObjectWithCoordinates[] = {
	BEGIN(OBJ_LIST_LEVEL),
	OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
	SET_HITBOX(/*Radius*/ 100, /*Height*/ 100),
	SET_INT(oIntangibleTimer, 0),
	BEGIN_LOOP(),
		CALL_NATIVE(bhv_collide_check_loop),
	END_LOOP(),
};

const BehaviorScript bhvSquishMarioObj[] = {
	BEGIN(OBJ_LIST_SURFACE),
	OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
	LOAD_COLLISION_DATA(ccc_boss_squish_collision),
	BEGIN_LOOP(),
		CALL_NATIVE(bhv_squish_mario_loop),
		CALL_NATIVE(load_object_collision_model),
	END_LOOP(),
};
...
const BehaviorScript bhvBbbPathControlledLift[] = {
	BEGIN(OBJ_LIST_SURFACE),
	OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
	LOAD_COLLISION_DATA(bbb_path_controlled_lift_collision),
	SET_HOME(),
	BEGIN_LOOP(),
		CALL_NATIVE(bhv_bbb_path_controlled_lift_loop),
		CALL_NATIVE(load_object_collision_model),
	END_LOOP(),
};
...
const BehaviorScript bhvGoombaBoss[] = {
	BEGIN(OBJ_LIST_PUSHABLE),
	OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
	DROP_TO_FLOOR(),
	LOAD_ANIMATIONS(oAnimations, goomba_seg8_anims_0801DA4C),
...
const BehaviorScript bhvGoombaMinion[] = {
	BEGIN(OBJ_LIST_PUSHABLE),
	OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
	DROP_TO_FLOOR(),
	LOAD_ANIMATIONS(oAnimations, goomba_seg8_anims_0801DA4C),
...
const BehaviorScript bhvGoombaBossHandler[] = {
	BEGIN(OBJ_LIST_GENACTOR),
	OR_INT(oFlags, OBJ_FLAG_COMPUTE_DIST_TO_MARIO),
	BEGIN_LOOP(),
		CALL_NATIVE(bhv_goomba_boss_handler_update),
	END_LOOP(),
};
...
const BehaviorScript bhvKingBooMirror[] = {
	BEGIN(OBJ_LIST_DEFAULT),
	OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
	CALL_NATIVE(bhv_init_room),
	CALL_NATIVE(bhv_boo_mirror_init),
	BEGIN_LOOP(),
		CALL_NATIVE(bhv_king_boo_mirror_loop),
	END_LOOP(),
};
...
const BehaviorScript bhvSlidingPlatform3[] = {
	BEGIN(OBJ_LIST_SURFACE),
	OR_INT(oFlags, (OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
	SET_HOME(),
	CALL_NATIVE(bhv_sliding_platform_3_init),
	BEGIN_LOOP(),
		CALL_NATIVE(bhv_sliding_platform_3_loop),
		CALL_NATIVE(load_object_collision_model),
	END_LOOP(),
};

const BehaviorScript bhvCccSlidingPlatformSpecial[] = {
	BEGIN(OBJ_LIST_SURFACE),
	LOAD_COLLISION_DATA(ccc_huge_ice_block_lift_collision),
	OR_INT(oFlags, (OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
	SET_HOME(),
	CALL_NATIVE(bhv_ccc_sliding_platform_special_init),
	BEGIN_LOOP(),
		CALL_NATIVE(bhv_ccc_sliding_platform_special_loop),
		CALL_NATIVE(load_object_collision_model),
	END_LOOP(),
};
