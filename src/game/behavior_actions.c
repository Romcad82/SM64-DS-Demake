...
void spawn_mist_particles_variable_at_obj(s32 count, s32 offsetY, f32 size, struct Object *obj) {
	sMistParticles.sizeBase = size;
	sMistParticles.sizeRange = size / 20.0f;
	sMistParticles.offsetY = offsetY;
	...
	obj_spawn_particles(&sMistParticles, obj);
}
...
#include "behaviors/squish_mario_obj.inc.c"
...
#include "behaviors/ice_falling_platform.inc.c"
...
#include "behaviors/bbb_merry_go_round.inc.c"
