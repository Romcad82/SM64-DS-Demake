...
#define AREA_CASTLE_REC_ROOM    LEVEL_AREA_INDEX(LEVEL_CASTLE, 4)
...
#define AREA_TSOBF				LEVEL_AREA_INDEX(LEVEL_TSOBF, 1)
#define AREA_SI					LEVEL_AREA_INDEX(LEVEL_SI, 1)
#define AREA_GB					LEVEL_AREA_INDEX(LEVEL_GB, 1)
#define AREA_GB_FIGHT			LEVEL_AREA_INDEX(LEVEL_GB, 2)
#define AREA_BBB				LEVEL_AREA_INDEX(LEVEL_BBB, 1)
#define AREA_BBB_FIGHT			LEVEL_AREA_INDEX(LEVEL_BBB, 2)
#define AREA_CCC				LEVEL_AREA_INDEX(LEVEL_CCC, 1)
#define AREA_CCC_FIGHT			LEVEL_AREA_INDEX(LEVEL_CCC, 2)
