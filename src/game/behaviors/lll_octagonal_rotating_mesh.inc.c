...
// Path for chief chilly challenge
static struct LllOctagonalMeshAction gCccOctagonalMeshAction0[] = {
	// instruction                time  moveAngle  forwardVel
	{ LLL_OCTMESH_LINEAR_MOVE,      30,			0,          0 }, // 0 degrees
	{ LLL_OCTMESH_CHANGE_DIR,      110,       900,         30 },
	{ LLL_OCTMESH_CHANGE_DIR,       30,         0,        -30 },
	{ LLL_OCTMESH_LINEAR_MOVE,      30,    0x8000,          0 }, // 180 degrees
	{ LLL_OCTMESH_CHANGE_DIR,      110,       900,         30 },
	{ LLL_OCTMESH_CHANGE_DIR,       30,         0,        -30 },
...
static struct LllOctagonalMeshAction *gLllOctagonalMeshActionList[] = { gLllOctagonalMeshAction0, gLllOctagonalMeshAction1, gCccOctagonalMeshAction0 };
...
void bhv_lll_moving_octagonal_mesh_platform_loop(void) {
	...
	if (gCurrLevelNum != LEVEL_CCC) {
		...
		o->oPosY = o->oLllOctMeshWaveYOffset + (-2650.0f) + o->oLllOctMeshYOffsetFromHome;
	}
    // Original: o->oPosY = o->oLllOctMeshWaveYOffset + o->oHomeY + o->oLllOctMeshYOffsetFromHome;
}
