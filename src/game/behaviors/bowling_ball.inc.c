...
static Trajectory sTsobfXMetalBallTraj[] = {
	TRAJECTORY_POS(0, /*pos*/ -2850, 0, 1000),
	TRAJECTORY_POS(1, /*pos*/  2525, 0, 1000),
	TRAJECTORY_END(),
};

static Trajectory sTsobfZMetalBallTraj[] = {
	TRAJECTORY_POS(0, /*pos*/ 1000, 0,  2850),
	TRAJECTORY_POS(1, /*pos*/ 1000, 0, -2525),
	TRAJECTORY_END(),
};
...
void bowling_ball_set_waypoints(void) {
    switch (o->oBehParams2ndByte) {
		...
		case BBALL_BP_STYPE_TSOBF_X:
			o->oPathedStartWaypoint = (struct Waypoint*) sTsobfXMetalBallTraj;
			break;

		case BBALL_BP_STYPE_TSOBF_Z:
			o->oPathedStartWaypoint = (struct Waypoint*) sTsobfZMetalBallTraj;
			break;
    }
}
...
void bhv_bowling_ball_loop(void) {
	...
	if ((o->oBehParams2ndByte == BBALL_BP_STYPE_TSOBF_X) && (o->oPosX >= 2400.0f)) {
		spawn_mist_particles();
		spawn_triangle_break_particles(30, MODEL_DIRT_ANIMATION, 3.0f, TINY_DIRT_PARTICLE_ANIM_STATE_YELLOW);
		cur_obj_play_sound_2(SOUND_GENERAL_BREAK_BOX);
		obj_mark_for_deletion(o);
	} else if ((o->oBehParams2ndByte == BBALL_BP_STYPE_TSOBF_Z) && (o->oPosZ <= -2400.0f)){
		spawn_mist_particles();
		spawn_triangle_break_particles(30, MODEL_DIRT_ANIMATION, 3.0f, TINY_DIRT_PARTICLE_ANIM_STATE_YELLOW);
		cur_obj_play_sound_2(SOUND_GENERAL_BREAK_BOX);
		obj_mark_for_deletion(o);
