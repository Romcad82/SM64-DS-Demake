...
void bhv_door_init(void) {
	...
	f32 multFactor = (GET_BPARAM3(o->oBehParams) * 2) + 200.0f;

    x = o->oPosX + sins(o->oMoveAngleYaw) * multFactor; // Original: x = o->oPosX + sins(o->oMoveAngleYaw) *  200.0f;
    z = o->oPosZ + coss(o->oMoveAngleYaw) * multFactor; // Original: z = o->oPosZ + coss(o->oMoveAngleYaw) *  200.0f;
