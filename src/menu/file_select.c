...
static const Vec3s sSaveFileButtonPositions[] = {
    ...
    {  273,   0, -100 }, // SAVE_FILE_B
    { -166, 311, -100 }, // SAVE_FILE_C
    { -166, -1244, -100 }, // SAVE_FILE_D
};
...
void render_menu_buttons(s32 selectedButtonID) {
    ...
    sMainMenuButtons[idx + 3]->oMenuButtonScale = 0.0f;
...
static const Vec3s sSaveFileButtonInitPositions[] = {
    ...
    { -2450,    0, 0 }, // SAVE_FILE_B
    {  1500, 2800, 0 }, // SAVE_FILE_C
    {  1500, -11200, 0 }, // SAVE_FILE_D
};
...
void bhv_menu_button_manager_init(void) {
    ...
    sMainMenuButtons[MENU_BUTTON_PLAY_FILE_D]->oMenuButtonScale = 0.0f;
    // Score menu button
...
void print_main_menu_strings(void) {
    ...
    print_save_file_star_count(SAVE_FILE_B, 151, 118);
    print_save_file_star_count(SAVE_FILE_C, SAVEFILE_X2, 78);
...
void print_score_menu_strings(void) {
    ...
    print_save_file_star_count(SAVE_FILE_B, 151, 119);
    print_save_file_star_count(SAVE_FILE_C, 211, 76);
    ...
    print_menu_generic_string(150, 105, textMarioB);
    print_menu_generic_string(211, 62, textMarioC);
...
void print_save_file_scores(s8 fileIndex) {
    ...
    print_menu_generic_string(LEVEL_NAME_X + SECRET_STARS_PAD, 23 + 12 * 16,
                              segmented_to_virtual(levelNameTable[30]));
