...
DEFINE_LEVEL("TSOBF", LEVEL_TSOBF, COURSE_TSOBF, tsobf, generic, 20000, 0x00, 0x00, 0x00, _, sCamTsobf) 
DEFINE_LEVEL("SI", LEVEL_SI, COURSE_SI, si, generic, 20000, 0x00, 0x00, 0x00, _, sCamSi) 
DEFINE_LEVEL("GB", LEVEL_GB, COURSE_GB, gb, fire, 20000, 0x00, 0x00, 0x00, _, sCamGb) 
DEFINE_LEVEL("BBB", LEVEL_BBB, COURSE_BBB, bbb, spooky, 20000, 0x00, 0x00, 0x00, _, sCamBbb) 
DEFINE_LEVEL("CCC", LEVEL_CCC, COURSE_CCC, ccc, generic, 20000, 0x00, 0x00, 0x00, _, sCamCcc) 
STUB_LEVEL("", LEVEL_UNKNOWN_44, COURSE_NONE, 20000, 0x00, 0x00, 0x00, _, _) 
