...
const LevelScript level_main_scripts_entry[] = {
	...
	LOAD_MODEL_FROM_GEO(MODEL_SILVER_STAR,             star_silver_geo),
	...
	LOAD_MODEL_FROM_GEO(MODEL_SUPER,                   mushroom_super_geo),
	...
	LOAD_MODEL_FROM_GEO(MODEL_ARROW_SIGN_LEFT,         arrow_sign_left_geo),
	LOAD_MODEL_FROM_GEO(MODEL_ARROW_SIGN_RIGHT,        arrow_sign_right_geo),
...
const LevelScript script_func_global_1[] = {
	...
	LOAD_MODEL_FROM_GEO(MODEL_STAR_CRYSTAL,			   star_crystal_geo),
    RETURN(),
};
