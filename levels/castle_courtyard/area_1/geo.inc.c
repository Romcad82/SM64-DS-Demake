...
const GeoLayout castle_courtyard_area_1_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, castle_courtyard_dl_Ignore_Collision_mesh_layer_1),
		GEO_DISPLAY_LIST(LAYER_ALPHA, castle_courtyard_dl_Ignore_Collision_mesh_layer_4),
		GEO_DISPLAY_LIST(LAYER_TRANSPARENT, castle_courtyard_dl_Ignore_Collision_mesh_layer_5),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, castle_courtyard_dl_r0_node_mesh_layer_1),
		GEO_DISPLAY_LIST(LAYER_ALPHA, castle_courtyard_dl_r0_node_mesh_layer_4),
