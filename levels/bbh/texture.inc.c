...
ALIGNED8 static const Texture bbh_seg7_texture_frame[] = {
#include "levels/bbh/7.rgba16.inc.c"
};

ALIGNED8 static const Texture bbh_seg7_texture_l1[] = {
#include "levels/bbh/8.rgba16.inc.c"
};

ALIGNED8 static const Texture bbh_seg7_texture_l2[] = {
