...
const LevelScript level_bbh_entry[] = {
    ...
    AREA(/*index*/ 1, geo_bbh_000F00),
		...
		OBJECT(MODEL_NONE, 2171, 1997, 973, 0, 90, 0, 0x00140000, bhvPaintingDeathWarp),
		...
		WARP_NODE(/*id*/ 0x14, /*destLevel*/ LEVEL_BBH, /*destArea*/ 0x01, /*destNode*/ 0x14, /*flags*/ WARP_NO_CHECKPOINT),
		PAINTING_WARP_NODE(0x06, LEVEL_BBB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		PAINTING_WARP_NODE(0x07, LEVEL_BBB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		PAINTING_WARP_NODE(0x08, LEVEL_BBB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
