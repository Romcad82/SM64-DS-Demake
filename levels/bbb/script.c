...
const LevelScript level_bbb_entry[] = {
	...
	AREA(1, bbb_area_1),
		...
		OBJECT(MODEL_BBB_PATH_CONTROLLED_LIFT, 4900, -120, -4900, 0, 90, 0, 0x3C010000, bhvBbbPathControlledLift),
		...
		OBJECT(MODEL_BBB_PATH_CONTROLLED_LIFT, 6200, -120, -3500, 0, 0, 0, 0x8C000000, bhvBbbPathControlledLift),
		OBJECT(MODEL_BBB_PATH_CONTROLLED_LIFT, 7000, -120, -2700, 0, 90, 0, 0x96000000, bhvBbbPathControlledLift),
		OBJECT(MODEL_BBB_PATH_CONTROLLED_LIFT, 7800, -120, -3500, 0, 180, 0, 0x96000000, bhvBbbPathControlledLift),
		OBJECT(MODEL_BBB_PATH_CONTROLLED_LIFT, 7000, -120, -4300, 0, -90, 0, 0x96000000, bhvBbbPathControlledLift),
		...
		OBJECT(MODEL_BBB_PATH_CONTROLLED_LIFT, 7530, 580, -10700, 0, 0, 0, 0x31010000, bhvBbbPathControlledLift),
		OBJECT(MODEL_BBB_PATH_CONTROLLED_LIFT, 6550, 90, -9960, 0, 0, 0, 0x35010000, bhvBbbPathControlledLift),
		OBJECT(MODEL_BBB_PATH_CONTROLLED_LIFT, 6550, 580, -10340, 0, 90, 0, 0x62000000, bhvBbbPathControlledLift),
