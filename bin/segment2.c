...
//
ALIGNED8 static const Texture texture_hud_char_0_s[] = {
#include "textures/segment2/segment2.00000_s.rgba16.inc.c"
};

ALIGNED8 static const Texture texture_hud_char_1_s[] = {
#include "textures/segment2/segment2.00200_s.rgba16.inc.c"
};

ALIGNED8 static const Texture texture_hud_char_2_s[] = {
#include "textures/segment2/segment2.00400_s.rgba16.inc.c"
};

ALIGNED8 static const Texture texture_hud_char_3_s[] = {
#include "textures/segment2/segment2.00600_s.rgba16.inc.c"
};

ALIGNED8 static const Texture texture_hud_char_4_s[] = {
#include "textures/segment2/segment2.00800_s.rgba16.inc.c"
};

ALIGNED8 static const Texture texture_hud_char_5_s[] = {
#include "textures/segment2/segment2.00A00_s.rgba16.inc.c"
};

ALIGNED8 static const Texture texture_hud_1up[] = {
#include "textures/segment2/segment2.big_1up.rgba16.inc.c"
};
...
const Texture *const main_hud_lut[] = {
    ...
    texture_hud_1up, texture_menu_silver_star,
    //
};
...
//
Gfx _1up_big_1up_8_ci8_aligner[] = {gsSPEndDisplayList()};
u8 _1up_big_1up_8_ci8[] = {
	, 
	
};

Gfx _1up_big_1up_8_pal_rgba16_aligner[] = {gsSPEndDisplayList()};
u8 _1up_big_1up_8_pal_rgba16[] = {
	, 
};

static const Vtx vertex_billboard_32x16[] = {
    {{{   -64,    -32,      0}, 0, {     0,  32<<4}, {0xff, 0xff, 0xff, 0xff}}},
    {{{    64,    -32,      0}, 0, { 32<<5,  32<<4}, {0xff, 0xff, 0xff, 0xff}}},
    {{{    64,     32,      0}, 0, { 32<<5,      0}, {0xff, 0xff, 0xff, 0xff}}},
    {{{   -64,     32,      0}, 0, {     0,      0}, {0xff, 0xff, 0xff, 0xff}}},
};

const Gfx dl_billboard_32x16_begin[] = {
    gsDPPipeSync(),
	gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, TEXEL0, 0, ENVIRONMENT, 0, TEXEL0, 0, SHADE, 0, TEXEL0, 0, ENVIRONMENT, 0),
	gsSPClearGeometryMode(G_CULL_BACK | G_LIGHTING | G_SHADING_SMOOTH),
	gsDPSetTextureLUT(G_TT_RGBA16),
	gsSPTexture(65535, 65535, 0, 0, 1),
	gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, _1up_big_1up_8_pal_rgba16),
	gsDPSetTile(0, 0, 0, 256, 5, 0, G_TX_WRAP | G_TX_NOMIRROR, 0, 0, G_TX_WRAP | G_TX_NOMIRROR, 0, 0),
	gsDPLoadTLUTCmd(5, 89),
	gsDPSetTextureImage(G_IM_FMT_CI, G_IM_SIZ_8b_LOAD_BLOCK, 1, _1up_big_1up_8_ci8),
...
Gfx dl_billboard_32x16_tri_0[] = {
	gsSPVertex(vertex_billboard_32x16 + 0, 4, 0),
	gsSP1Triangle(0, 1, 2, 0),
	gsSP1Triangle(0, 2, 3, 0),
	gsSPEndDisplayList(),
};

const Gfx dl_billboard_32x16_end[] = {
    gsDPPipeSync(),
...
//
const Gfx dl_billboard_num_0_s[] = {
	gsSPDisplayList(dl_billboard_num_begin),
	gsDPSetTextureImage(G_IM_FMT_IA, G_IM_SIZ_16b, 1, texture_hud_char_0_s),
	gsDPLoadSync(),
	gsDPLoadBlock(G_TX_LOADTILE, 0, 0, ((16 * 16) - 1), CALC_DXT(16, G_IM_SIZ_16b_BYTES)),
	gsSPDisplayList(dl_billboard_num_end),
	gsSPEndDisplayList(),
...
const Gfx dl_billboard_num_1_s[] = {
	gsSPDisplayList(dl_billboard_num_begin),
	gsDPSetTextureImage(G_IM_FMT_CI, G_IM_SIZ_16b, 1, texture_hud_char_1_s),
	gsDPLoadSync(),
	gsDPLoadBlock(G_TX_LOADTILE, 0, 0, ((16 * 16) - 1), CALC_DXT(16, G_IM_SIZ_16b_BYTES)),
	gsSPDisplayList(dl_billboard_num_end),
	gsSPEndDisplayList(),
...
const Gfx dl_billboard_num_2_s[] = {
	gsSPDisplayList(dl_billboard_num_begin),
	gsDPSetTextureImage(G_IM_FMT_CI, G_IM_SIZ_16b, 1, texture_hud_char_2_s),
	gsDPLoadSync(),
	gsDPLoadBlock(G_TX_LOADTILE, 0, 0, ((16 * 16) - 1), CALC_DXT(16, G_IM_SIZ_16b_BYTES)),
	gsSPDisplayList(dl_billboard_num_end),
	gsSPEndDisplayList(),
...
const Gfx dl_billboard_num_3_s[] = {
	gsSPDisplayList(dl_billboard_num_begin),
	gsDPSetTextureImage(G_IM_FMT_CI, G_IM_SIZ_16b, 1, texture_hud_char_3_s),
	gsDPLoadSync(),
	gsDPLoadBlock(G_TX_LOADTILE, 0, 0, ((16 * 16) - 1), CALC_DXT(16, G_IM_SIZ_16b_BYTES)),
	gsSPDisplayList(dl_billboard_num_end),
	gsSPEndDisplayList(),
...
const Gfx dl_billboard_num_4_s[] = {
	gsSPDisplayList(dl_billboard_num_begin),
	gsDPSetTextureImage(G_IM_FMT_CI, G_IM_SIZ_16b, 1, texture_hud_char_4_s),
	gsDPLoadSync(),
	gsDPLoadBlock(G_TX_LOADTILE, 0, 0, ((16 * 16) - 1), CALC_DXT(16, G_IM_SIZ_16b_BYTES)),
	gsSPDisplayList(dl_billboard_num_end),
	gsSPEndDisplayList(),
...
const Gfx dl_billboard_num_5_s[] = {
	gsSPDisplayList(dl_billboard_num_begin),
	gsDPSetTextureImage(G_IM_FMT_CI, G_IM_SIZ_16b, 1, texture_hud_char_5_s),
	gsDPLoadSync(),
	gsDPLoadBlock(G_TX_LOADTILE, 0, 0, ((16 * 16) - 1), CALC_DXT(16, G_IM_SIZ_16b_BYTES)),
	gsSPDisplayList(dl_billboard_num_end),
	gsSPEndDisplayList(),
...
const Gfx dl_billboard_1up[] = {
    gsSPDisplayList(dl_billboard_32x16_begin),
	gsSPDisplayList(dl_billboard_32x16_tri_0),
	gsSPDisplayList(dl_billboard_32x16_end),
	gsDPPipeSync(),
	gsSPSetGeometryMode(G_LIGHTING),
