                     ...
                     GEO_OPEN_NODE(),
                        ...
                        GEO_OPEN_NODE(),
                           ...
                           GEO_OPEN_NODE(),
                              ...
                              GEO_OPEN_NODE(),
                                 GEO_ASM(0, geo_offset_klepto_held_object),
                                 GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_TRANSPARENT, 0, 100, 0, 180, 270, 0, transparent_star_seg3_dl_body), // Original: LAYER_OCCLUDE_SILHOUETTE_OPAQUE
                              GEO_CLOSE_NODE(),
                           GEO_CLOSE_NODE(),
						   GEO_NODE_START(), // KLEPTO_ANIM_STATE_HOLDING_SILVER_STAR
						   GEO_OPEN_NODE(),
							  GEO_SCALE(0x00, 16384),
							  GEO_OPEN_NODE(),
								 GEO_ASM(0, geo_offset_klepto_held_silver_star),
								 GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OCCLUDE_SILHOUETTE_OPAQUE, 0, 100, 0, 180, 270, 0, star_silver_seg3_dl_body),
								 GEO_ASM(0, geo_offset_klepto_held_silver_star),
								 GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OCCLUDE_SILHOUETTE_ALPHA, 0, 100, 0, 180, 270, 0, star_silver_seg3_dl_eyes),
							  GEO_CLOSE_NODE(),
						   GEO_CLOSE_NODE(),
                        GEO_CLOSE_NODE(),
                     GEO_CLOSE_NODE(),
