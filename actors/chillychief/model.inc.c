...
//
const Gfx chilly_chief_seg5_dl_0500C500[] = { // This was added to prevent Weird Lighting glitch where if Mario has vanish cap, chilly's lighting will be messed up. This isn't exclusive to chilly, but even stranger, this glitch only happens to objects (such as bobombs) in TSOBF, BBB, & CCC. No other levels in the game (including SI & GB) has this glitch with vanish cap. Doing this seems to fix it for some reason?
	gsDPPipeSync(),
	gsDPSetCombineMode(G_CC_SHADE, G_CC_SHADE),
	gsDPPipeSync(),
	gsDPSetCombineMode(G_CC_SHADE, G_CC_SHADE),
	gsSPDisplayList(chilly_chief_seg6_dl_06002B30),
	gsSPEndDisplayList(),
};
//
