...
ALIGNED8 static const Texture door_seg3_texture_eight_star_door_sign[] = {
#include "actors/door/eight_star_door_sign.rgba16.inc.c"
};
...
const Gfx door_seg3_dl_eight_stars_near[] = {
	gsSPDisplayList(door_seg3_vertex_star_sign_begin),
	gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, door_seg3_texture_eight_star_door_sign),
	gsDPLoadSync(),
	gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
	gsSPVertex(door_seg3_vertex_star_sign_near, 4, 0),
	gsSPBranchList(door_seg3_vertex_star_sign_end),
...
// 0x03014340 - 0x03014370
const Gfx door_seg3_dl_eight_stars_far[] = {
	gsSPDisplayList(door_seg3_vertex_star_sign_begin),
	gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, door_seg3_texture_eight_star_door_sign),
	gsDPLoadSync(),
	gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
