...
enum SurfaceTypes {
    ...
    SURFACE_0006,                       // 0x0006 // Unused // Alternate MGR Music Floor (Quiet, Noise)
    SURFACE_0007,                       // 0x0007 // Unused // Noise Not-Slippery
    SURFACE_0008,                       // 0x0008 // Unused // Alternate MGR Music Floor (Quiet, Default)
    SURFACE_SLOW,                       // 0x0009 // Slow down Mario, unused
    SURFACE_DEATH_PLANE,                // 0x000A // Death floor
    SURFACE_CLOSE_CAMERA,               // 0x000B // Close camera
	SURFACE_SUPER_SLIPPERY,             // 0x000C // Super slippery surface, good for delimiting your level
    ...
    SURFACE_MGR_MUSIC,                  // 0x001A // Plays the Merry go round music, see handle_merry_go_round_music in bbh_merry_go_round.inc.c & bbb_merry_go_round.inc.c for more details
