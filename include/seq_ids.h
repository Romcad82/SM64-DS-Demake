...
enum SeqId {
	...
	SEQ_LEVEL_SI,                     // 0x23
	SEQ_EVENT_BOSS_INTRO,			  // 0x24
	SEQ_EVENT_CUTSCENE_COLLECT_SS1,	  // 0x25
	SEQ_EVENT_DROP_STAR,			  // 0x26
	SEQ_EVENT_CUTSCENE_COLLECT_SS2,	  // 0x27
	SEQ_EVENT_CUTSCENE_COLLECT_SS3,	  // 0x28
