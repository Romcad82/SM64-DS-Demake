...
extern const BehaviorScript bhvRotatingClockwise[];
...
extern const BehaviorScript bhvFiveCoinsSpawn[];
...
extern const BehaviorScript bhvBbbTumblingBridge[];
...
extern const BehaviorScript bhvGbUpDownLog[];
...
extern const BehaviorScript bhvFallingIcePlatformA[];
extern const BehaviorScript bhvFallingIcePlatformB[];
extern const BehaviorScript bhvFallingIcePlatformC[];
extern const BehaviorScript bhvFallingIcePlatform[];
...
extern const BehaviorScript bhvCccMovingOctagonalMeshPlatform[];
...
extern const BehaviorScript bhvGbTiltingInvertedPyramid[];
extern const BehaviorScript bhvCccTiltingInvertedPyramid[];
...
extern const BehaviorScript bhvArrowSignLeft[];
extern const BehaviorScript bhvArrowSignRight[];
...
extern const BehaviorScript bhvKingBoo[];
...
extern const BehaviorScript bhvRedCoinBoo[];
...
extern const BehaviorScript bhvBbbTiltingTrapPlatform[];
...
extern const BehaviorScript bhvBbbMerryGoRound[];
...
extern const BehaviorScript bhvStarReference[];
...
extern const BehaviorScript bhvCustomDoorWarp[];
...
extern const BehaviorScript bhvLitBobomb[];
...
extern const BehaviorScript bhvTsobfBowlingBallSpawner[];
...
extern const BehaviorScript bhvSilversHiddenStar[];
extern const BehaviorScript bhvHiddenSwitchStar[];
extern const BehaviorScript bhvHiddenStarTrigger[];
extern const BehaviorScript bhvSilverStar[];
extern const BehaviorScript bhvSpawnObjectFromAnother[];
extern const BehaviorScript bhvSpawnObjectWithCoordinates[];
extern const BehaviorScript bhvSquishMarioObj[];
...
extern const BehaviorScript bhvBbbPathControlledLift[];
...
extern const BehaviorScript bhvGoombaBoss[];
extern const BehaviorScript bhvGoombaMinion[];
extern const BehaviorScript bhvGoombaBossHandler[];
...
extern const BehaviorScript bhvKingBooMirror[];
...
extern const BehaviorScript bhvSlidingPlatform3[];
extern const BehaviorScript bhvCccSlidingPlatformSpecial[];
